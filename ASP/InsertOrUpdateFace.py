...
button_1 = Button(
    image=bt1, borderwidth=0, highlightthickness=0, command=clear, relief="flat"
)
button_1.place(x=1100.0, y=300, width=220, height=80)
