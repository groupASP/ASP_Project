...
background = canvas.create_image(600.0, 337.5, image=background_img)

img0 = PhotoImage(file=f"ASP/Image/login.png")
b0 = Button(
    image=img0, borderwidth=0, highlightthickness=0, command=login, relief="flat"
)

b0.place(x=111, y=578, width=392, height=62)
...
entry0.place(x=118.0, y=327, width=375.0, height=58)

entry1_img = PhotoImage(file=f"ASP/Image/img_textBox1.png")
entry1_bg = canvas.create_image(305.5, 473.0, image=entry1_img)

entry1 = Entry(font=("Times New Roman", 20), bd=0, bg="#e5e5e5", highlightthickness=0)

entry1.place(x=118.0, y=443, width=375.0, height=58)
entry1.config(show="*")
...
cb1 = Checkbutton(
    window, text="Show Password", variable=var1, onvalue=1, offvalue=0, command=showpw
)
