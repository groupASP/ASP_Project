...
def save_update():
    ...
    sql_update = (
        "update tb_class set cl_name='" + n_name + "' where cl_id='" + n_id + "';"
    )
...
def open():
    frm.withdraw()
    os.system("D:\ASP_Project\ASP\insert_Class.py")
...
background_img = tk.PhotoImage(file=f"ASP/Image/bg_class.png")
