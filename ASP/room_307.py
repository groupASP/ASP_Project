                ...
                if str(profile[11]) != "0":
                    ...
                    while True:
                        if x == index:
                            ...
                            for i in range(90, 0, -1):
                                servo(pin, i)
                        break
                elif str(profile[5]) == "307" and str(profile[6]) == "HCS6A":
                    ...
                    if time_now < start_Class:
                        ...
                        while True:
                            ...
                            sleep(1)
                            break
                elif str(profile[5]) == "307" and str(profile[6]) == "HCS6B":
                    local_time = pytz.timezone("Asia/Bangkok")
                    a = 0
                    b = 1
                    date_Today = datetime.now(tz=local_time).strftime("%Y-%m-%d")
                    ...
                    if time_now < start_Class:
                        ...
                        while True:
                            ...
                            sleep(1)
                            break
                elif str(profile[5]) == "307" and str(profile[6]) == "HCS6C":
                    local_time = pytz.timezone("Asia/Bangkok")
                    a = 0
                    b = 1
                    date_Today = datetime.now(tz=local_time).strftime("%Y-%m-%d")
                    ...
                    if time_now < start_Class:
                        ...
                        while True:
                            ...
                            sleep(1)
                            break
                elif str(profile[5]) == "307" and str(profile[6]) == "HCS6D":
                    local_time = pytz.timezone("Asia/Bangkok")
                    a = 0
                    b = 1
                    date_Today = datetime.now(tz=local_time).strftime("%Y-%m-%d")
                    ...
                    if time_now < start_Class:
                        ...
                        while True:
                            ...
                            sleep(1)
                            break
                elif str(profile[5]) == "307" and str(profile[6]) == "HCS6E":
                    local_time = pytz.timezone("Asia/Bangkok")
                    a = 0
                    b = 1
                    date_Today = datetime.now(tz=local_time).strftime("%Y-%m-%d")
                    ...
                    if time_now < start_Class:
                        ...
                        while True:
                            ...
                            sleep(1)
                            break
                elif str(profile[5]) == "307" and str(profile[6]) == "HCS6F":
                    local_time = pytz.timezone("Asia/Bangkok")
                    a = 0
                    b = 1
                    date_Today = datetime.now(tz=local_time).strftime("%Y-%m-%d")
    ...
    try:
        ...
        def auto():
            ...
            try:
                ...
                r_Name = str(profile[5])
                cl_Name = str(profile[6])
                if str(profile[5]) == "307" and str(profile[6]) == "HCS6A":
