...
b0.place(x=850, y=750, width=250, height=73)

img1 = PhotoImage(file=f"ASP/Image/logout.png")
b1 = Button(
    image=img1, borderwidth=0, highlightthickness=0, command=logout, relief="flat"
)

b1.place(x=450, y=750, width=250, height=73)
...
b4 = Button(
    image=img4, borderwidth=0, highlightthickness=0, command=room, relief="flat"
)

b4.place(x=1160, y=300, width=180, height=180)

img5 = PhotoImage(file=f"ASP/Image/class.png")
b5 = Button(
    image=img5, borderwidth=0, highlightthickness=0, command=clas, relief="flat"
)

b5.place(x=660, y=300, width=180, height=180)

img6 = PhotoImage(file=f"ASP/Image/face.png")
b6 = Button(
    image=img6, borderwidth=0, highlightthickness=0, command=face, relief="flat"
)

b6.place(x=150, y=300, width=180, height=180)

img7 = PhotoImage(file=f"ASP/Image/attan.png")
b7 = Button(
    image=img7, borderwidth=0, highlightthickness=0, command=attan, relief="flat"
)

b7.place(x=1160, y=80, width=180, height=180)

img8 = PhotoImage(file=f"ASP/Image/t.png")
b8 = Button(
    image=img8, borderwidth=0, highlightthickness=0, command=teacher, relief="flat"
)

b8.place(x=660, y=80, width=180, height=180)

img9 = PhotoImage(file=f"ASP/Image/st.png")
b9 = Button(image=img9, borderwidth=0, highlightthickness=0, command=stu, relief="flat")

b9.place(x=150, y=80, width=180, height=180)

img10 = PhotoImage(file=f"ASP/Image/table.png")
b10 = Button(
    image=img10, borderwidth=0, highlightthickness=0, command=sche, relief="flat"
)

b10.place(x=660, y=520, width=180, height=180)
###############################################################################
