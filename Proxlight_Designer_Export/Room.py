...
def save_update():
    ...
    sql_update = "update tb_room set r_name='"+n_name+"' where r_id='"+n_id+"';"
    ...
    sql_select = "select * from tb_room;"
...
def open():
    frm.withdraw()
    os.system("D:\ASP_Project\Proxlight_Designer_Export\insert_Room.py")
...
background_img = tk.PhotoImage(file = f"Proxlight_Designer_Export/Image/bg_insert.png")
background = canvas.create_image(
    950.0, 540.0,
    image=background_img)
img1 = tk.PhotoImage(file=f"Proxlight_Designer_Export/Image/add.png")
btAdd = tk.Button(
    image=img1,
    borderwidth=0,
    highlightthickness=0,
...
img2 = tk.PhotoImage(file=f"Proxlight_Designer_Export/Image/back.png")
btBack = tk.Button(
    image=img2,
    borderwidth=0,
    highlightthickness=0,
...
img3 = tk.PhotoImage(file=f"Proxlight_Designer_Export/Image/delete.png")
btDelete = tk.Button(
    image=img3,
    borderwidth=0,
    highlightthickness=0,
...
img4 = tk.PhotoImage(file=f"Proxlight_Designer_Export/Image/edit.png")
btEdit = tk.Button(
    image=img4,
    borderwidth=0,
    highlightthickness=0,
...
img5 = tk.PhotoImage(file=f"Proxlight_Designer_Export/Image/bt_update.png")
